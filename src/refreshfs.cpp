...
static int do_getattr(const char *path, struct stat *st)
{
	...
	cout << "List of Dirs After Update=======================================================================================================================\n";
	if(listOfDirs.size()!= 0)
	{
		for(auto i = listOfDirs.begin(); i != listOfDirs.end(); ++i)
		{
			cout << *i << ", ";
		}
		cout << endl;
	...
	if(newFiles.size() > 0 && !updateInProgress)
	{
		...
		for(auto i = newFiles.begin(); i != newFiles.end(); ++i)
		{
			...
			myfile.open (fpath);
			cout << "2" << endl;
			myfile << "GET_FROM_DHT GET_FROM_DHT GET_FROM_DHT GET_FROM_DHT GET_FROM_DHT GET_FROM_DHT GET_FROM_DHT GET_FROM_DHT GET_FROM_DHT GET_FROM_DHT GET_FROM_DHT";
			cout << "3" << endl;
			myfile.close();
			cout << "4" << endl;
...
int main(int argc, char *argv[])
{
    ...
    node.bootstrap("138.23.32.237", "4224");
